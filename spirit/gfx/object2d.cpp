...
uint32_t rgba_to_uint(uint8_t r, uint8_t g, uint8_t b, uint8_t a) {
  return static_cast<int>(a) << 24 | static_cast<int>(b) << 16 |
         static_cast<int>(g) << 8 | static_cast<int>(r);
}

Object2d::Object2d(const glm::vec3 &pos, float w, float h, uint8_t r, uint8_t g,
                   uint8_t b, uint8_t a)
...
Object2d::Object2d(const glm::vec3 &pos, float w, float h, const Texture &texture,
...
Object2d::Object2d(const glm::vec3 &pos, const Texture &texture,
...
float Object2d::get_w() const { return _w; }

float Object2d::get_h() const { return _h; }

float Object2d::get_type() const { return _type; }
